...
@section('content')
    <h2 class="text-2xl font-bold mb-6 text-gray-800 dark:text-white">Edit Site Setting</h2>
    <form action="{{ route('site-settings.update', $siteSetting->id) }}" method="POST"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="col-span-full">
                ...
                <input type="text" name="key" value="{{ $siteSetting->key }}"
            ...
            <div class="col-span-full">
                ...
                <textarea name="value" rows="4"
                    class="w-full mt-1 p-2 border border-gray-300 rounded-lg dark:bg-gray-900 dark:border-gray-700 focus:ring-2 focus:ring-blue-500 focus:outline-none">{{ $siteSetting->value }}</textarea>
            </div>
        </div>
