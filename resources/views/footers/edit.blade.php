...
@section('content')
    <h2 class="text-2xl font-bold mb-6 text-gray-800 dark:text-white">Edit Footer Section</h2>
    <form action="{{ route('footers.update', $footer->id) }}" method="POST"
        ...
        <div class="space-y-4">
            <div>
                ...
                <input type="text" name="section_title" value="{{ $footer->section_title }}"
            ...
            <div>
                ...
                <textarea name="content" rows="4"
                    class="w-full mt-1 p-2 border border-gray-300 rounded-lg dark:bg-gray-900 dark:border-gray-700 focus:ring-2 focus:ring-blue-500 focus:outline-none"
                    required>{{ $footer->content }}</textarea>
            </div>
        </div>
