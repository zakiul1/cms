        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="col-span-full">
                ...
                <textarea name="description" rows="4"
                    class="w-full mt-1 p-2 border border-gray-300 rounded-lg dark:bg-gray-900 dark:border-gray-700 focus:ring-2 focus:ring-blue-500 focus:outline-none">{{ $product->description }}</textarea>
            </div>
            ...
            <div class="col-span-full">
                ...
                @if($product->image)
                    <img src="{{ asset('storage/' . $product->image) }}" class="h-20 mt-3 rounded shadow-md">
                @endif
            </div>
        </div>
