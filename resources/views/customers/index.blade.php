        ...
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            <thead class="bg-gray-50 dark:bg-gray-700">
                <tr>
                    ...
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase">Website
                        URL</th>
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                @forelse($customers as $customer)
                    <tr>
                        ...
                        <td class="px-6 py-4">
                            @if($customer->logo)
                                <img src="{{ asset('storage/' . $customer->logo) }}" class="h-12 w-20 object-contain rounded">
                            @else
                                <span class="text-xs text-gray-400">No Logo</span>
                            @endif
                        </td>
                        <td class="px-6 py-4 text-sm text-blue-600 dark:text-blue-400">{{ $customer->website_url }}</td>
